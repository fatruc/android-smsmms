...
public class Utils {
	 ...
	 * 
	 * @param account
	 *            is the string of the account name to get the auth token for
	 * @param context
	 *            is the context of the activity or service
	 ...
	 *            is the context of the activity or service
	 * @param url
	 *            is the MMSC to check
	 * @param proxy
	 *            is the proxy of the APN to check
	 * @throws java.io.IOException
	 *             when route cannot be established
	 */
	 ...
	 *            is the context of the activity or service
	 * @param enabled
	 *            is whether to enable or disable data
	 */
	 ...
	 * 
	 * @param settings
	 *            is the settings object to check against
	 * @param text
	 *            is the text from the message object to be sent
	 ...
	 *            is the context of the activity or service
	 * @param recipient
	 *            is the person message is being sent to
	 ...
	 *            is the context of the activity or service
	 * @param recipients
	 *            is the set of people message is being sent to
	 * @return the thread_id to use in the database
	 */
